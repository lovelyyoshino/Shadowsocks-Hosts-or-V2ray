...
- ### IPv6
	...
	*4. 如果hosts失效可以将下载文档中的hosts删除并重新添加googlehosts生成的ipv6[hosts文件](https://github.com/googlehosts/hosts-ipv6/blob/master/hosts-files/hosts) （If hosts fails, the hosts which is in the download document can be deleted and added to the Scprits which hosts file generated by lennylxx.）*
- ### IPv4
